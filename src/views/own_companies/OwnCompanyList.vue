<template>
	...
	<div v-animate>
		...
		<div v-animate v-if="isCreate">
			<Create @saveOwnCompanyForm="saveOwnCompanyForm" @cancelCreate="cancelCreate" />
		</div>

		<!-- BEGIN: Page Layout Update -->
		<div v-animate v-if="isEdit">
			<Edit :ownCompanyId="ownCompanyId" @cancelEdit="cancelEdit" @updateOwnCompanyForm="updateOwnCompanyForm" />
		</div>
		...
		<div v-animate class="p-5 border rounded-md shadow-sm" id="div_table">
			<div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
				...
				<div class="flex mt-5 sm:mt-0">
					<button class="btn-primary w-1/2 sm:w-auto mr-2" @click.prevent="showCreateOwnCompany">
			...
			<div class="overflow-x-auto scrollbar-hidden">
				<div id="tabulator" ref="table" class="mt-5 table-report table-report--tabulator"></div>
			</div>
		</div>
	</div>
</template>
	...
	tabulator.value = new Tabulator(table.value, {
		...
		columns: [
			...
			},
			{
				...
				cellClick: (e, cell) => {
					showEditOwnCompany(cell.getData().id);
					e.preventDefault();
				},
			},
			{
				...
				cellClick: (e, cell) => {
					//deleteOwnCompany(cell.getData().id, cell.getData().name);
					showDeleteOwnCompany(cell.getData().id);
					e.preventDefault();
				},
			},
		],
