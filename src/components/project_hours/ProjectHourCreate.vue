			...
			<div class="grid grid-cols-12 gap-6">
				...
				<div class="col-span-12 md:col-span-6 lg:col-span-4">
					<div class="input-form">
						...
						<input v-model.trim="validate.project_id.$model" id="project_id" type="text" name="project_id"
							class="form-control" :class="{ 'border-danger': validate.project_id.$error }" />
						<template v-if="validate.project_id.$error">
							<div v-for="(error, index) in validate.project_id.$errors" :key="index"
				...
				<div class="col-span-12 md:col-span-6 lg:col-span-4">
					<div class="input-form">
						...
						<input v-model.trim="validate.invoice_header_id.$model" id="invoice_header_id" type="text"
							name="invoice_header_id" class="form-control"
							:class="{ 'border-danger': validate.invoice_header_id.$error }" />
						<template v-if="validate.invoice_header_id.$error">
							<div v-for="(error, index) in validate.invoice_header_id.$errors" :key="index"
								class="text-danger mt-2">
								{{ error.$message }}
							</div>
						</template>
				...
				<div class="col-span-12 md:col-span-6 lg:col-span-4">
					<div class="input-form">
						...
						<input v-model.trim="validate.hours.$model" id="hours" type="text" name="hours"
							class="form-control" :class="{ 'border-danger': validate.hours.$error }" />
				...
				<div class="col-span-12 md:col-span-6 lg:col-span-4">
					<div class="input-form">
						...
						<input v-model.trim="validate.invoice_at.$model" id="invoice_at" type="text" name="invoice_at"
							class="form-control" :class="{ 'border-danger': validate.invoice_at.$error }" />
						<template v-if="validate.invoice_at.$error">
							<div v-for="(error, index) in validate.invoice_at.$errors" :key="index"
								class="text-danger mt-2">
								{{ error.$message }}
							</div>
						</template>
